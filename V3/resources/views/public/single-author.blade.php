            ...
            <div class="col-lg-8">
                <div class="author-info">
                    <div class="media media-none--xs">
                        <img src='{{asset("image/users/$user->image")}}' alt="Blog Author"
                            style="width: 182px; height: 182px;" class="rounded-circle media-img-auto">
                        <div class="media-body">
                            <h2 class="author-title">{{$user->firstName}} {{$user->lastName}}</h2>
                            <div class="author-designation">
                                <hr style="width: 45%; border: 1px solid tomato ; color: #ff4f57;">
                            </div>
                            <p>{{$user->bio}}</p>
                        </div>
                        ...
                        @else
                        <a class="btn-lg text-white" style="background: tomato;"
                            href="/author/{{$user->id}}/follow">Follow</a>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            ...
                            <div class="item-content">
                                ...
                                <ul class="entry-meta">
                                    <li><a href="#"><i class="fas fa-clock"></i>{{$post->preparation_time}} Mins</a>
                                    </li>
                                    <li><a href="#"><i class="fas fa-user"></i>by
                                            <span>{{$post->user->firstName}}</span></a></li>
                                    <li><a href="#"><i class="fas fa-heart"></i><span>{{$post->follows}}</span>
                                            Follows</a></li>
                                    @auth
                                    @if(!$post->likedBy(auth()->user()->id))
                                    <li>
                                        <a href="/like/{{$post->id}}" class=" text-danger" style="font-size: 1.5rem"><i
                                                class="fas fa-heart">Like</i></a><span>{{$post->likes->count()}}
                                            {{ Str::plural('like',$post->likes->count())}}</span>
                                    </li>
                                    @else
                                    <li>
                                        <a href="/like/delete/{{$post->id}}" class=" text-danger"
                                            style="font-size: 1.5rem" style="font-size: 1.5rem"><i
                                                class="fas fa-heart">Unlike</i></a><span>{{$post->likes->count()}}
                                            {{ Str::plural('like',$post->likes->count())}}</span>
                                    </li>
                                    @endif
                                    @endauth
                                    ...
                                    @guest
                                    <li>
                                        <a href="/login" class=" text-danger" style="font-size: 1.5rem"><i
                                                class="fas fa-heart">Like</i></a><span>{{$post->likes->count()}}
                                            {{ Str::plural('like',$post->likes->count())}}</span>
                                    </li>
                                    @endguest
            ...
            <div class="col-lg-4 sidebar-widget-area sidebar-break-md">
                <div class="widget">
                    ...
                    <div class="widget-featured-feed">
                        <div class="rc-carousel nav-control-layout1" data-loop="true" data-items="3" data-margin="5"
                            ...
                            <div class="featured-box-layout1">
                                <div class="item-img">
                                    <img src="{{asset('public/img/product/product17.jpg')}}" alt="Brand"
                                        class="img-fluid">
                                </div>
                                <div class="item-content">
                            ...
                            <div class="featured-box-layout1">
                                <div class="item-img">
                                    <img src="{{asset('public/img/product/product18.jpg')}}" alt="Brand"
                                        class="img-fluid">
                                </div>
                                <div class="item-content">
                            ...
                            <div class="featured-box-layout1">
                                <div class="item-img">
                                    <img src="{{asset('public/img/product/product19.jpg')}}" alt="Brand"
                                        class="img-fluid">
                                </div>
                                <div class="item-content">
                        ...
                        <ul class="block-list">
                            <li class="single-item">
                                ...
                                <div class="item-content">
                                    ...
                                    <div class="item-post-by"><a href="single-blog.html"><i
                                                class="fas fa-user"></i><span>by</span>
                                            John Martin</a></div>
                                </div>
                            </li>
                            <li class="single-item">
